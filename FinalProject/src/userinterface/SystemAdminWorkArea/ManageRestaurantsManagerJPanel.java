 ...
 * @author 30481
 */
public class ManageRestaurantsManagerJPanel extends javax.swing.JPanel {
    ...
    public ManageRestaurantsManagerJPanel(JPanel userProcessContainer, EcoSystem ecosystem,WorkQueue wq) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblRestaurantsManager = new javax.swing.JTable();
        ...
        tblRestaurantsManager.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
            ...
            new String [] {
                "Restaurants Manager ID", "Restaurants Manager Name"
            }
        ) {
        ...
        jScrollPane1.setViewportView(tblRestaurantsManager);
        ...
        jLabel1.setText("Restaurants Manager List:");

        jLabel2.setText("New Restaurants Manager:");
        ...
        jLabel4.setText("Restaurants Manager Name");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(43, 43, 43)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(txtCustomerName, javax.swing.GroupLayout.DEFAULT_SIZE, 147, Short.MAX_VALUE)
...
//        Role role = (Role) cmbRoles.getSelectedItem();
        ...
        system.getSellerDirectory().createRestaurant(customerID, customerName, userName, password);
    ...
    private javax.swing.JTable tblRestaurantsManager;
    ...
    private void refreshTable() {
      DefaultTableModel model = (DefaultTableModel) tblRestaurantsManager.getModel();
        model.setRowCount(0);
     
       for(Seller s: system.getSellerDirectory().getRestaurantList()){
